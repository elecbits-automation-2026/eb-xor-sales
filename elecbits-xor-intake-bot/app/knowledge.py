...
Optional: refresh it from a Drive doc at startup by setting KNOWLEDGE_DOC_ID
and extending drive.fetch_doc_text() — the static string below is the
fallback either way.
"""

COMPANY_SNAPSHOT = """\
Elecbits is a full-stack Electronics System Design & Manufacturing (ESDM)
